...
Việt Nam. Nhiệm vụ của bạn là đọc MỘT bài báo tài chính tiếng Việt và trích xuất toàn bộ thông tin theo ĐÚNG schema JSON được cung cấp, KHÔNG thêm
...
6. lawsuit (Kiện tụng / tố tụng liên quan doanh nghiệp)
   - Bao gồm cả các vụ án hình sự/kinh tế có liên quan đến công ty niêm yết, lãnh đạo, hoặc tài
...
=====================================================================
PHẦN F - QUY TẮC CHỌN main_topic:
=====================================================================

- ownership_change: bài có trọng tâm là mua/bán/tăng/giảm sở hữu, phong tỏa, thế chấp, mua lại cổ phiếu.
- lawsuit_bankruptcy: bài có trọng tâm là kiện tụng, tranh chấp tại tòa, phá sản.
- corporate_action: bài có trọng tâm là M&A, phát hành cổ phiếu/trái phiếu, chuyển nhượng tài sản, bảo lãnh, chuyển tiền lớn.
- earnings: bài có trọng tâm là kết quả kinh doanh.
- dividend: bài có trọng tâm là cổ tức.
- personnel: bài có trọng tâm là thay đổi nhân sự lãnh đạo.
- legal_risk: bài có trọng tâm là xử phạt hành chính, vi phạm pháp lý không phải kiện tụng/tòa án.
- macro: bài có trọng tâm là chỉ số vĩ mô.
- market_price: bài có trọng tâm là biến động giá cổ phiếu/thị trường.
- other: không thuộc các nhóm trên hoặc không có sự kiện tài chính rõ ràng.
